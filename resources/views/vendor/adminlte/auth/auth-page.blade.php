...
@section('body')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 login-page bg-white d-flex flex-column justify-content-between">
                <a href="/"><img src="/storage/images/logo.png" width="200"></a>
                ...
                <div class="text-center">
                    Copyright © 2024 <strong> {{ config('adminlte.copyright', '') }}</strong>. All rights reserved.
                    <strong>Ver. </strong>{{ config('adminlte.version', '0.0.0') }}
                </div>
